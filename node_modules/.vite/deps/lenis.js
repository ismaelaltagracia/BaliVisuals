...
var Lenis = class {
	...
	*/
	...
	onVirtualScroll = (data) => {
		...
		const hasTouchInertia = isTouch && event.type === "touchend" && Math.abs(delta) > 5;
	...
	*/
	get limit() {
		if (this.options.__experimental__naiveDimensions) if (this.isHorizontal) return this.rootElement.scrollWidth - this.rootElement.clientWidth;
